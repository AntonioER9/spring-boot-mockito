...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach() {
        collegeStudent.setFirstname("Antonio");
        collegeStudent.setLastname("Espinoza");
        collegeStudent.setEmailAddress("antoni@gmail.com");
    ...
    public void invokePrivateMethod(){
        assertEquals("Antonio 1", ReflectionTestUtils.invokeMethod(collegeStudent, "getFirstNameAndId"),
